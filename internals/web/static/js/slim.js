$(function(){
  ...
  var path   = loc.split('/');
  var isRtl  = false; // Default to false for local development
  var isSidebar = false; // Default to false for local development
  var newloc = '';
  ...
  // Removed external template settings request for local development
  // Original code that loaded from themepixels.me is commented out
  
  // Set up template settings without external request
  if($.fn.perfectScrollbar) {
